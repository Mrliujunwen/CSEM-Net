...
from networks.CCSA import ChannelAttention
from networks.CCSA import CCSA
import torch
...
class SS2Dv2:
    def __initv2__(
        ...
        self.att = ChannelAttention(input_channels=1536, internal_neurons=1536)
        self.ccsa = CCSA(dim=1536, head_num=8, window_size=7)
        self.conv = nn.Conv2d(1536, 1536, kernel_size=(1, 1), padding=0)
        self.batchnorm = nn.BatchNorm2d(1536)
...
if __name__ == "__main__":
    ...
    input = torch.randn(4,47,47,768).cuda()
    out = vsb(input)
    print(out.shape)
